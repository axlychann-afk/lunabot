...
class MimoAI {
  ...
  async sendMessage(params = {}) {
    ...
    const payload = {
      ...
      subscription: MimoCrypto.obfuscate('yearly'),
    ...
    return new Promise((resolve, reject) => {
      ...
      // Penjaga timeout: jika stream tidak selesai, jangan biarkan request menggantung
      const timeout = setTimeout(() => {
        apiResponse.data.destroy();
        settle(reject, new Error('Mimo AI request timed out'));
      }, 90000);
